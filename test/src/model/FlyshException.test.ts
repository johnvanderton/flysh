 ...
 * TODO : produce an exception in case of only one element from selector (#selector !empty! !empty!)
 * TODO : produce an exception in case of unexpected parameter (#selector parent child !unexpected!)
 */
